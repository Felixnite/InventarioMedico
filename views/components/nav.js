...
const crearNavHome = () => {
    navegacion.innerHTML = `
        <nav class="bg-[#4769c2] shadow-lg fixed w-full z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20 items-center">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#" class="ml-4 text-sm font-semibold text-[#4769c2] bg-white py-2 px-4 rounded-full 
            ...
            <div id="mobile-menu" class="md:hidden fixed right-4 bg-gray-200 rounded-sm shadow-xl z-50 w-64 hidden">
                <div class="py-4">
